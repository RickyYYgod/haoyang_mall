package com.hsbiopharm.mall.controller.common;

import com.google.code.kaptcha.impl.DefaultKaptcha;
import com.google.code.kaptcha.util.Config;
import com.hsbiopharm.mall.common.Constants;
...
public class CommonController {
    ...
    @ApiOperation(value = "后台管理登录获取验证码", notes = "后台管理登录获取验证码")
    @ApiImplicitParams({
    })
    ...
    @RequestMapping(value = "/mall/kaptcha", method = {RequestMethod.GET})
    @ApiOperation(value = "前台商城登录获取验证码", notes = "前台商城登录获取验证码")
    @ApiImplicitParams({
    })
